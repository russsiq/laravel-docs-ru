...
Перевод документации пополняется по мере обращения к соответствующим разделам либо приоритет отдается файла с наименьшим весом. Разделы помеченные галочками уже имеют переводы.
