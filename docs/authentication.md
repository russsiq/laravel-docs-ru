...
> {tip} Если вы хотите ограничить количество запросов к другим маршрутам своего приложении, ознакомьтесь с [документацией по ограничению количества запросов](routing.md#rate-limiting).
