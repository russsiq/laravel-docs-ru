# Laravel 8.x — Примечания к выпуску
...
Функционал ограничения частоты запросов в Laravel был расширен за счет большей гибкости и возможностей, при этом сохранена обратная совместимость с API посредника `throttle` предыдущих версий.
