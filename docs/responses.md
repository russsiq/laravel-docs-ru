...
> **Примечание**\
> Знаете ли вы, что можете возвращать [коллекции Eloquent](eloquent-collections.md) из ваших маршрутов или контроллеров? Они будут автоматически преобразованы в JSON.
