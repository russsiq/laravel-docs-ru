...
Параметр `--model` используется для задания имени модели созданной фабрики. Этот параметр предварительно заполнит сгенерированный файл фабрики переданной моделью:
