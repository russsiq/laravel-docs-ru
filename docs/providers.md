...
С помощью команды `make:provider` интерфейса командной строки Artisan можно создать нового поставщика:
