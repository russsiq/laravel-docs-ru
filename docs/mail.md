...
> **Примечание**\
> Вы можете указывать тип зависимостей в методе `build` почтового отправления. [Контейнер служб](container.md) автоматически внедрит любые необходимые зависимости.
