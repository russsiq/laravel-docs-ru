...
> **Примечание**\
> Если вам нужно начать разработку приложения с помощью Laravel и [Tailwind CSS](https://tailwindcss.com), ознакомьтесь с одним из наших [стартовых комплектов приложения](starter-kits.md).
