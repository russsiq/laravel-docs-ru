...
После создания файла версионирования вы не узнаете его точное имя. Итак, вы должны использовать глобальную функцию Laravel `mix` в вашем [шаблоне](views.md) для загрузки хешированного ресурса. Функция `mix` автоматически определит текущее имя хешированного файла:
