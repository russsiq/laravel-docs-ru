...
Файл `webpack.mix.js` вашего приложения является отправной точкой для компиляции всех веб-активов. Думайте об этом как о легкой конфигурационной обертке вокруг [Webpack](https://webpack.js.org). Задачи Mix могут можно объединить в цепочку при определении того, как должны быть скомпилированы ваши веб-активы.
