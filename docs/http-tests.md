...
Laravel предлагает очень гибкий API для выполнения HTTP-запросов к вашему приложению и проверки ответов. Например, взгляните на функциональный тест, расположенный ниже:
