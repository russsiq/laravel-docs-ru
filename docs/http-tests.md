...
> **Примечание**\
> Более общий метод [assertValid](#assert-valid) может использоваться для утверждения о том, что ответ не содержит ошибок валидации, которые были возвращены как JSON **и**, что ошибки не были записаны в сессию.
...
> **Примечание**\
> Более общий метод [assertInvalid](#assert-invalid) может использоваться для утверждения о том, что ответ содержит ошибки валидации, которые были возвращены как JSON **или**, что ошибки были записаны в сессию.
...
> **Примечание**\
> Более общий метод [`assertInvalid`](#assert-invalid) может использоваться для утверждения о том, что в ответе есть ошибки валидации, которые были возвращены в виде структуры JSON **или**, что ошибки были переданы в хранилище сессии.
...
> **Примечание**\
> Более общий метод [`assertValid`](#assert-valid) может использоваться для утверждения о том, что в ответе нет ошибок валидации, которые были возвращены в виде структуры JSON **и**, что ошибки не были переданы в хранилище сессии.
