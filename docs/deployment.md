...
> **Примечание**\
> Хотите полное руководство по развертыванию с помощью Laravel Forge? Посетите [Laravel Bootcamp](https://bootcamp.laravel.com/deploying) и серии видео о Forge, [доступные на Laracasts](https://laracasts.com/series/learn-laravel-forge-2022-edition).
